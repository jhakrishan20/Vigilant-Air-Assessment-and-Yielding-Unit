...
const char* ssid = "Airtel_Jai Shree Ram"; // Your WiFi SSID
const char* password = "JaiShree_Ram@108"; // Your WiFi password
const char* serverName = "http://192.168.1.4:3000/gasData"; // Your Node.js server endpoint
